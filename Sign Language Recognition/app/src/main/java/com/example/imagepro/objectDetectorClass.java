...
public class  objectDetectorClass {
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Log.d("objecDetectorClass","output_class_value: "+output_class_value[0][0]);
    ...
    private String get_alphabet(float sig_v) {
        String val ="";
        if(sig_v>=-8.5 & sig_v<0.5){
            val="A";
        }
        else if(sig_v>-8.5 & sig_v<1.5){
            val="B";
        }
